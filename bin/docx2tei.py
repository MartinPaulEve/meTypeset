...
class Docx2TEI :
    ...
    def  run(self):
        ...
        #copy folders
        gv.copy_folder(self.gv.COMMON2_LIB_PATH, self.gv.COMMON2_TEMP_FOLDER_PATH, False, None)
        gv.copy_folder(self.gv.DOCX_FOLDER_PATH, self.gv.DOCX_TEMP_FOLDER_PATH,False,None)
        ...
        if os.path.exists(self.gv.DOCX_MEDIA_PATH):
            gv.copy_folder(self.gv.DOCX_MEDIA_PATH, gv.settings.script_dir,False,None)
